    ...
    public static class DataInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var TheExecutiveRoom = new MeetingRoom()
            {
                ...
                PriceEvening = 175,
                PriceFullDay = 250,
                ImageName = "the_executive_room.jpeg",

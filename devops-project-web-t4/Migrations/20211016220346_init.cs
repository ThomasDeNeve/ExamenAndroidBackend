        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PriceAfEnToe = table.Column<double>(type: "float", nullable: false),
                    PriceHalftime = table.Column<double>(type: "float", nullable: false),
                    PriceFulltime = table.Column<double>(type: "float", nullable: false),
                    PriceFixedDown = table.Column<double>(type: "float", nullable: false),
                    PriceFixedUp = table.Column<double>(type: "float", nullable: false),

...
namespace devops_project_web_t4.Areas.Controllers
{
    public interface ISubscriptionController
    {
        ...
        /// <summary>Get the subscription for a certain customer in an asynchronous way.</summary>
        /// <param name="customerName">The name of the customer</param>
        /// <param name="month">The month where the subscription is active.</param>
        public Task<List<CustomerSubscription>> GetCustomerSubscriptionsAsync(string customerName = null, DateTime? month = null);
